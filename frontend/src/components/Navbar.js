...
import { Menu, X, Globe, User, LogOut, LayoutDashboard, Building2, Shield, HelpCircle, MessageCircle, Camera, Star, Heart, Plane } from 'lucide-react';
...
export const Navbar = () => {
  ...
  const navLinks = [
    ...
    { href: '/passagens', label: language === 'pt' ? 'Passagens' : 'Flights', icon: Plane },
    { href: '/seguro', label: language === 'pt' ? 'Seguro' : 'Insurance', icon: Shield },
